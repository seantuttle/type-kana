...
rText.addEventListener("input", () => {
    hText.value = toHiragana(rText.value)
    kText.value = toKatakana(rText.value)
})

hText.addEventListener("input", () => {
    rText.value = toRomaji(hText.value)
    kText.value = toKatakana(hText.value)
})

kText.addEventListener("input", () => {
    hText.value = toHiragana(kText.value)
    rText.value = toRomaji(kText.value)
})